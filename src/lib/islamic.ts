...
export const morningAzkar = [
  {
    ...
    transliteration: 'Aṣbaḥnā wa aṣbaḥa al-mulku lillāhi, walḥamdulillāh, lā ilāha illallāhu waḥdahu lā sharīka lahu, lahul-mulku wa lahul-ḥamdu, wa huwa `alā kulli shay’in qadīr.',
