...
export function NamazIcon({ className }: { className?: string }) {
  return (
    ...
    >
        ...
        <path d="M14,4v4" stroke="#FFF" stroke-width="2" stroke-linecap="round"/>
        <path d="M34,4v4" stroke="#FFF" stroke-width="2" stroke-linecap="round"/>
        <path d="M24,22c-4.4,0-8,3.6-8,8s3.6,8,8,8s8-3.6,8-8S28.4,22,24,22z" fill="#FFC107"/>
        <path d="M24,24v6h4" stroke="#FFF" stroke-width="2" stroke-linecap="round"/>
    </svg>
  );
}
